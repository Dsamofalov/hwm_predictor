...
### Final validated ability source and integration into main

- The intermediate Hexing shared-`ray` checkpoint `73179d404559693722db94a47215bc28aae572dc` / run `31693303773` remained **FAIL** because the new shared status decode correctly changed exact Child/Hexing corpus aggregates; it was not used as an integration source.
- Exact corpus locks were synchronized to the independently observed `ray` population without adding a Hexing proc rule, Child school inference, or other speculative mechanics. Final validated ability source: `2ae1046c48e99c94da3481a8b3ed81285b9125ab`; hosted Ability Windows run `31697180629`, check-suite `85986692434` — **PASS / completed with conclusion `success`**.
- Integration started from main source `2d6c985fbc4a6725e64871f12b127d68f86f1000`. The ability-owned state was connected by real two-parent merge commit `e69592eaa9461825e231cc73656d1e58b9ac4ffd`; shared `replay.py` was resolved semantically rather than taking either side wholesale.
