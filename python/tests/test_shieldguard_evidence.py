...
from hwm_solver.ability.shieldguard_evidence import analyze_corpus
...
def test_shieldguard_whole_corpus_evidence():
    ...
    assert report["physical_attacks_in_carrier_battles"] > 0
    warnings.warn(
        "SHIELDGUARD_EVIDENCE "
